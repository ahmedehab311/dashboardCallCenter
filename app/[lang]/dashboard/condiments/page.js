...
const Condiments = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-6 text-center">Condiments</h1>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {currentItems.map((section) => (
       <Card key={section.id} className="border rounded-lg overflow-hidden shadow-md">
            <CardHeader
            ...
            <CardFooter
              ...
              isSection={true}
              isActive={section.isActive}
              onToggleActive={(checked) => handleToggleActive(section.id, checked)}
              trans={trans}
            />
          </Card>
        ))}
